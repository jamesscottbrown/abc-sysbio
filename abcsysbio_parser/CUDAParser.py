...
class CUDAParser(Parser):
    ...
    def renameEverything(self):
        ...
        for nam in range(len(self.mathPython)):
            for k in range(len(self.writer.parsedModel.kineticLaw)):
            ...
            for k in range(len(self.writer.parsedModel.ruleFormula)):
            ...
            for k in range(len(self.writer.parsedModel.eventFormula)):
            ...
            for k in range(len(self.writer.parsedModel.eventCondition)):
            ...
            for k in range(len(self.writer.parsedModel.functionBody)):
            ...
            for fun in range(len(self.writer.parsedModel.listOfFunctions)):
                for k in range(len(self.writer.parsedModel.functionArgument[fun])):
