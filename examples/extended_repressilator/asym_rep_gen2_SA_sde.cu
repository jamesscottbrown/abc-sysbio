...
#define k2_1 tex2D(param_tex,3,tid)
#define k2_2 tex2D(param_tex,4,tid)
#define k2_3 tex2D(param_tex,5,tid)

#define Rm_1 tex2D(param_tex,6,tid)
#define Rm_2 tex2D(param_tex,7,tid)
#define Rm_3 tex2D(param_tex,8,tid)

#define sigma_1s tex2D(param_tex,9,tid)
#define sigma_2s tex2D(param_tex,10,tid)
#define sigma_3s tex2D(param_tex,11,tid)

#define sigma_1t tex2D(param_tex,12,tid)
#define sigma_2t tex2D(param_tex,13,tid)
#define sigma_3t tex2D(param_tex,14,tid)

#define delta_1s tex2D(param_tex,15,tid)
#define delta_2s tex2D(param_tex,16,tid)
#define delta_3s tex2D(param_tex,17,tid)

#define delta_1t tex2D(param_tex,18,tid)
#define delta_2t tex2D(param_tex,19,tid)
#define delta_3t tex2D(param_tex,20,tid)

#define tlA tex2D(param_tex,21,tid)
#define tlB tex2D(param_tex,22,tid)
#define tlC tex2D(param_tex,23,tid)

#define degA tex2D(param_tex,24,tid)
#define degB tex2D(param_tex,25,tid)
#define degC tex2D(param_tex,26,tid)

#define degmA tex2D(param_tex,27,tid)
#define degmB tex2D(param_tex,28,tid)
#define degmC tex2D(param_tex,29,tid)

#define S1 tex2D(param_tex,30,tid)
#define S2 tex2D(param_tex,31,tid)
#define S3 tex2D(param_tex,32,tid)
#define S4 tex2D(param_tex,33,tid)
#define S5 tex2D(param_tex,34,tid)
#define S6 tex2D(param_tex,35,tid)

//Code for texture memory

__device__ double fa( double A , double B , double C , double tid ){
	return Rm_1*(k1_1 + switchp(S1)*sigma_1s*A*A + switchp(S5)*sigma_1t*B*B)/(1 + k1_1 + k2_1*C*C + switchp(S1)*sigma_1s*A*A + switchn(S1)*delta_1s*A*A + switchp(S5)*sigma_1t*B*B + switchn(S5)*delta_1t*B*B);
}

__device__ double fb( double A , double B , double C , double tid ){
	return Rm_2*(k1_2 + switchp(S2)*sigma_2s*B*B + switchp(S6)*sigma_2t*C*C)/(1 + k1_2 + k2_2*A*A + switchp(S2)*sigma_2s*B*B + switchn(S2)*delta_2s*B*B + switchp(S6)*sigma_2t*C*C + switchn(S6)*delta_2t*C*C);
}

__device__ double fc( double A , double B , double C , double tid ){
	return Rm_3*(k1_3 + switchp(S3)*sigma_3s*C*C + switchp(S4)*sigma_3t*A*A)/(1 + k1_3 + k2_3*B*B + switchp(S3)*sigma_3s*C*C + switchn(S3)*delta_3s*C*C + switchp(S4)*sigma_3t*A*A + switchn(S4)*delta_3t*A*A);
}
