...
$python_exe -u $abcSysBio_exe -i Repressilator_submodels_input_file_multiVariateNormalKNeigh.xml -of=results_multiVariateNormalKNeigh_1 -cu -lc >& log_multiVariateNormalKNeigh_1
