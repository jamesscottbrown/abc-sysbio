...
$python_exe -u $abcSysBio_exe -i Repressilator_submodels_input_file_multiVariateNormalOCM.xml -of=results_multiVariateNormalOCM_1 -cu -lc >& log_multiVariateNormalOCM_1
